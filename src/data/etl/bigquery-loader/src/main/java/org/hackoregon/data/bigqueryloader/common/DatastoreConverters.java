...
package org.hackoregon.data.bigqueryloader.common;
                            ...
                            new DoFn<KV<byte[], Iterable<Entity>>, Entity>() {
                                ...
                                public void processElement(ProcessContext c) throws IOException {
                                    ...
                                    if (entities.hasNext()) {
                                        do {
                                            duplicatedKeys.inc();
                                            ErrorConverters.ErrorMessage errorMessage = ErrorConverters.ErrorMessage.newBuilder()
                            ...
                            new DoFn<Entity, Entity>() {
                                ...
                                public void processElement(ProcessContext c) throws IOException {
                                    ...
                                    if (entity.hasKey()) {
                                        ...
                                        ErrorConverters.ErrorMessage errorMessage =
                                                ErrorConverters.ErrorMessage.newBuilder()
